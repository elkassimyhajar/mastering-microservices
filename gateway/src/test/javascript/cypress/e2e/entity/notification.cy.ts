...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2023-02-08T06:52:09.457Z',
    sentDate: '2023-02-08T07:19:12.531Z',
    format: 'EMAIL',
    userId: 20600,
    productId: 75536,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2023-02-07T14:21').blur().should('have.value', '2023-02-07T14:21');

      cy.get(`[data-cy="details"]`).type('firewall multimedia').should('have.value', 'firewall multimedia');

      cy.get(`[data-cy="sentDate"]`).type('2023-02-08T00:00').blur().should('have.value', '2023-02-08T00:00');
