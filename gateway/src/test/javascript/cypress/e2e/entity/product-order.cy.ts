...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = { placedDate: '2023-02-08T10:18:11.294Z', status: 'CANCELLED', code: 'Buckinghamshire' };
  ...
  describe('new ProductOrder page', () => {
    ...
    it('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2023-02-08T04:29').blur().should('have.value', '2023-02-08T04:29');
