...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    date: '2023-02-08T06:14:40.470Z',
    status: 'PAID',
    paymentMethod: 'PAYPAL',
    paymentDate: '2023-02-08T05:11:11.622Z',
    paymentAmount: 4928,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      cy.get(`[data-cy="date"]`).type('2023-02-07T18:44').blur().should('have.value', '2023-02-07T18:44');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2023-02-08T01:12').blur().should('have.value', '2023-02-08T01:12');
